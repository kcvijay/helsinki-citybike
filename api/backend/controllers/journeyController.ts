...
const getAllData = asyncHandler(
  async (req: Request, res: Response, collectionName: string) => {
    ...
    const limit = (req.query.limit as number | undefined) || 200; // Default limit is 25 unless otherwise defined in query.
    // const page = parseInt(req.query.page) || 1; // Default page is 1 unless otherwise defined in query
