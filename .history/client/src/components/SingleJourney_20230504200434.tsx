  ...
  return (
    <>
      <div className="wrapper">
        <div className="text-white flex flex-wrap gap-8 justify-start items-center ">
          ...
          <div className="hidden md:block text-3xl text-black rounded-full bg-white px-2 py-2">
