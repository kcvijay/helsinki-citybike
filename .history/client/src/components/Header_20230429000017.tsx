...
const Header = () => {
  ...
  return (
    <>
      <header className="bg-orange-400 flex justify-between items-center p-6 md:p-0">
        <Link to="/" className="block text-2xl font-bold text-white">
          Helsinki City Bike
        </Link>
        ...
        <div
          className="material-icons text-[36px] text-white"
