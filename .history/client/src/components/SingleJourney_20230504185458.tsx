      ...
      <div className="wrapper">
        <div className="text-white">
          ...
          <h2 className="text-xl md:text-3xl text-white font-bold uppercase mb-4">
            ...
            <span className="block w-max text-xl text-black rounded-md font-normal bg-transparent py-2 px-6">
          ...
          <h2 className="text-xl md:text-3xl text-white font-bold uppercase">
            ...
            <span className="block w-max text-xl text-black rounded-md font-normal bg-white py-2 px-6">
