      ...
      <div className="wrapper">
        ...
        <div className="bg-white p-5 rounded-md shadow-sm shadow-slate-100 grid grid-cols-1 md:grid-cols-2 gap-4 transition-all duration-300">
          <div>
            ...
            <div className="mb-6">
              <h3 className="text-md">Total Number of Journeys</h3>
              <p className="text-md text-slate-500">{data?.total_journeys}</p>
              <p className="text-md text-slate-500"></p>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-xl font-bold mb-3">Top 5 Return Stations</h3>
            <ul>
              {returnStationData &&
