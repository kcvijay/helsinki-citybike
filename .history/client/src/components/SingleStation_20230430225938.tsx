...
const SingleStation = () => {
  ...
  return (
    <div className="wrapper">
      ...
      <div className="bg-white p-6 rounded-md shadow-sm shadow-slate-100 grid grid-cols-1 md:grid-cols-2 gap-4 transition-all duration-300">
        <div>
          <div className="mb-6">
        ...
        <div className="h-[300px] md:h-auto">
          <iframe
            ...
            width="100%"
            height="100%"
            src={`https://www.openstreetmap.org/export/embed.html?bbox=${data?.x}%2C%2C${data?.x}%2C${data?.y}&amp;layer=mapnik&amp;marker=${data?.y}%2C${data?.x}`}
          ></iframe>
        </div>
