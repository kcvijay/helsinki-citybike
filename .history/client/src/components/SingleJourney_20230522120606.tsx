    ...
    <>
      <div className="wrapper">
        ...
        <div className="flex items-center gap-4">
          <p className="flex justify-between items-center bg-white px-4 py-2 text-black rounded-md">
            <p className="material-icons text-slate-500">directions_bike</p>
            <p className="block">
          ...
          <p className="flex justify-center items-center bg-white px-4 py-2 text-black rounded-md">
