...
const Header = () => {
  ...
  return (
    <>
      ...
      {showNav && (
        <ul className="md:hidden absolute bg-[rgba(0,0,0,0.9)] top-[84px] left-0 min-h-[100vh] min-w-[100vw] z-[999] text-center text-white hover:text-black transition-all duration-300">
          <li>
            <NavLink
