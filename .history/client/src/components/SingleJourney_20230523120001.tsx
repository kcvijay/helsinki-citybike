    ...
    <>
      <div className="wrapper">
        ...
        <div className="flex justify-start items-center gap-4">
          <p className="flex w-[200px] justify-between items-center bg-white px-4 py-2 rounded-md">
          ...
          <p className="flex w-[200px] justify-center items-center bg-white px-4 py-2 rounded-md">
