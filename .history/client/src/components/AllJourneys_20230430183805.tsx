  ...
  return (
    <div className="wrapper">
      ...
      <table className="bg-white border border-white mx-auto w-full transition-all duration-300">
        <caption className="relative text-left p-3 bg-white text-slate-500 border border-white">
          <input
            className="w-full h-full p-3 pr-14"
            type="text"
            pattern="[a-z][0-9]"
            id="search"
            name="search"
            ...
            spellCheck={"false"}
          ></input>
          <button className="material-icons absolute top-6 right-6">
            search
          </button>
        </caption>
