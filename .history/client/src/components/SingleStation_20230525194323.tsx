        ...
        <div className="bg-white p-5 rounded-md shadow-sm shadow-slate-100 grid grid-cols-1 md:grid-cols-2 gap-4 transition-all duration-300">
            ...
            <ul>
              {returnStationData &&
                returnStationData.map((data, index) => {
                  return (
                    <li className="mb-2 border-b border-slate-200 py-2">
                      {index + 1}. {data.return_station_name} (
                      {data.return_station_id}): {data.count}){" times"}
                    </li>
                  );
                })}
            </ul>
          ...
          <div className="mb-6">
            <table className="w-full text-sm">
              <caption className="bg-orange-500 md:bg-white py-1">
