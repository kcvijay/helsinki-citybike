...
const SingleJourney = () => {
  ...
  useEffect(() => {
    if (journeyData) {
      setReturnStationData(stationData || undefined);
    }
  }, [journeyData]);

  useEffect(() => {
    if (journeyData) {
      setDepartureStationData(stationData || undefined);
    }
  }, [journeyData]);
  ...
  console.log("depa" + departureStationData);
