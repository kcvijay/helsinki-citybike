...
const SingleStation = () => {
  ...
  if (loading) {
    return (
      <div className="flex py-[50px] justify-center items-center rounded-full">
    ...
    <>
      <div className="wrapper">
        ...
        <div className="bg-white p-5 rounded-md shadow-sm shadow-slate-100 grid grid-cols-1 md:grid-cols-2 gap-4 transition-all duration-300">
          ...
          <div className="mb-6">
            <p className="text-xl mb-3.5">Top 5 Return Stations</p>
            <ul className="w-auto border border-slate-200 p-4 rounded-md shadow-md">
              {returnStationData &&
                returnStationData.map((data, index) => {
                  return (
                    <li className="border-b border-slate-200 py-2">
                      {index + 1}. {data.return_station_name} [
                      {data.return_station_id}]{" "}
          ...
          <div className="mb-6">
            <p className="text-xl mb-3.5">Top 5 Departure Stations</p>
            <ul className="w-auto border border-slate-200 p-4 rounded-md shadow-md">
              {returnStationData &&
                returnStationData.map((data, index) => {
                  return (
