    ...
    <div className="wrapper">
      ...
      <div className="bg-white p-6 rounded-md shadow-sm shadow-slate-100 grid grid-cols-2 gap-4">
        ...
        <div>
          <iframe
            title="map"
            src={`https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d1984.324680860958!2d${data?.y}!3d${data?.x}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zNjDCsDEwJzMxLjMiTiAyNMKwNDgnMDcuNCJF!5e0!3m2!1sen!2sfi!4v1682883817120!5m2!1sen!2sfi`}
            width="600"
            height="450"
            loading="lazy"
          ></iframe>
