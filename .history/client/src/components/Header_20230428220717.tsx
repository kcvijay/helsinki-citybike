  ...
  return (
    <header className="bg-teal-500 flex justify-between items-center">
      ...
      <ul className="inline-flex">
        <li className="inline-block w-[150px] p-8 hover:bg-teal-300 transition-all duration-300">
          <NavLink to="/">Home</NavLink>
        </li>
        <li className="inline-block p-8 hover:bg-teal-300 transition-all duration-300">
