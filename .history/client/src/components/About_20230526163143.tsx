  ...
  return (
    <div className="wrapper bg-white p-12">
      ...
      <p className="leading-10 mb-4">
        The purpose of this application is to show and visualize not just
        consumer riding journeys but, also the information about CityBike
        Helsinki bicycle stations in Helsinki and Espoo area. At this moment,
        there are over 2 millions of journey data are available between May 2021
        and July 2021.
      </p>
