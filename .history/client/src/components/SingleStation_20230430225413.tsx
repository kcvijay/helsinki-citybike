      ...
      <div className="bg-white p-6 rounded-md shadow-sm shadow-slate-100 grid grid-cols-2 gap-4">
        ...
        <div>
          <iframe
            ...
            width="100%"
            height="100%"
            src={`https://www.openstreetmap.org/export/embed.html?bbox=24.82220828533173%2C%2C24.83272254467011%2C60.172758748746524&amp;layer=mapnik&amp;marker=60.171524%2C24.82746700000007`}
          ></iframe>
        </div>
