    ...
    <div className="wrapper">
      ...
      <div className="bg-white p-6 rounded-md shadow-sm shadow-slate-100 grid grid-cols-1 md:grid-cols-2 gap-4 transition-all dura">
        ...
        <div className="h-[300px] md:h-auto">
          <iframe
            title={data?.name}
            src={`https://www.openstreetmap.org/export/embed.html?bbox=24.814842939376835%2C60.183752515589696%2C24.82535719871521%2C60.18621967170903&amp;layer=mapnik&amp;marker=${data?.y}%2C${data?.x}`}
          ></iframe>
          <br />
          <small>
            <a href="https://www.openstreetmap.org/?mlat=60.18499&amp;mlon=24.82010#map=18/60.18499/24.82010">
              View Larger Map
            </a>
          </small>
        </div>
