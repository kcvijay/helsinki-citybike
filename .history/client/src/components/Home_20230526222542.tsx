...
const Home = () => {
  return (
    <div className="wrapper grid grid-4fr-2fr h-[50vh]">
      <div className="bg-slate-100 p-[48px]">
      ...
      <div className="w-full h-full bg-cycle bg-bottom bg-no-repeat object-cover"></div>
    </div>
  );
};
