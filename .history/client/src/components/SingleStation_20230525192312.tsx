    ...
    <>
      <div className="wrapper">
        ...
        <div className="bg-white p-5 rounded-md shadow-sm shadow-slate-100 grid grid-cols-1 md:grid-cols-2 gap-4 transition-all duration-300">
          ...
          <div className="h-[300px] md:auto relative transition-all duration-300">
            <iframe
          ...
          <div className="mb-6">
            <table className="w-full">
              <caption className="border-t-2 border-slate-200 py-1">
          ...
          <div className="mb-6">
            <table className="w-full">
              <caption className="border-2 border-slate-200 py-1">
                Top 5 Return Stations
              </caption>
              <thead className="bg-orange-500 text-white">
                <tr>
