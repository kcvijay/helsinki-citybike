      ...
      <div className="bg-white overflow-hidden">
        <table className="mx-auto w-full transition-all duration-300">
          <caption>
            ...
            laborum delectus voluptatum assumenda dolorum adipisci, deleniti
            minus voluptate vero, magni optio. Corrupti soluta doloribus
            asperiores vero iusto, optio eligendi aperiam.
          </caption>
