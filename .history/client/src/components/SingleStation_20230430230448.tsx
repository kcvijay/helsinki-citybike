      ...
      <div className="bg-white p-6 rounded-md shadow-sm shadow-slate-100 grid grid-cols-1 md:grid-cols-2 gap-4 transition-all dura">
        ...
        <div className="h-[300px] md:h-auto">
          <iframe
            ...
            title={data?.name}
            src={`https://www.openstreetmap.org/export/embed.html?bbox=24.814842939376835%2C${data?.y}%2C24.82535719871521%2C60.18621967170903&amp;layer=mapnik&amp;marker=${data?.y}%2C${data?.x}`}
          ></iframe>
          <br />
          <small>
